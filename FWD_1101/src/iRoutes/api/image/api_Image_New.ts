...
route_image_new.use(
    express.static(__dirname + "../../../public/iWeb", { etag: false })
);
route_image_new.use(
    express.static(__dirname + "../../../public/iWeb/img", { etag: false })
);

route_image_new.use(
    express.static(__dirname + "../../../public/iWeb/css", { etag: false })
);
 ...
 */
      ...
      path.join(
        ...
        res.status(200).redirect(
            `/api/img/get?filename=${x}&width=300&height=300`
        );
    } catch (error) {
